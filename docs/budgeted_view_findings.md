...
30-eval 지도(평균 +10.3%)를 rev3(300+250 evals)와 라운드 3(+450 evals,
07-18)으로 씬당 누적 ~1,018세트까지 재탐색한 결과 (아래 표는 rev3 시점,
라운드 3 갱신 폭은 전 씬 +1.0% 이하 — `oracle5_map_report.md` 참조):
