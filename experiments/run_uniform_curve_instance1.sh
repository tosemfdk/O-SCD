#!/bin/bash
# Fill in the uniform saturation curve on Instance_1: K=2,8,10,15
# (K=3,5,25 already in experiments/paslcd_nbv_results.csv). Resumable.
set -eo pipefail
...
for K in 2 8 10 15; do
    for CLS in "${CLASSES[@]}"; do
        run_one "Instance_1/$CLS" uniform "$K" 0
    done
done
echo "UNIFORM CURVE COMPLETE"
